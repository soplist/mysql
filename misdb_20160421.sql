...
update user set real_name="Íõ¿µ1" where name="wang";
update user set real_name="Íõ¿µ2" where name="wangkang";
update user set real_name="Íõ¿µ3" where name="kang";
...
insert into department values(1,"ÐÂ´«Ã½ÊÂÒµ²¿");
insert into department values(2,"¼Ò¾ÓÊÂÒµ²¿");
insert into department values(3,"¾­Óª¹ÜÀí²¿");
insert into department values(4,"¿Æ¼¼ÊÂÒµ²¿");
...
insert into staff_score values(1,1,1,'2016-04-15',30,'category1','´òÉ¨ÎÀÉú',1,'ÎÞ',1);
insert into staff_score values(2,2,2,'2016-04-15',15,'category2','´òÉ¨ÎÀÉú',2,'ÎÞ',2);
insert into staff_score values(3,3,3,'2016-04-15',50,'category3','´òÉ¨ÎÀÉú',3,'ÎÞ',3);
